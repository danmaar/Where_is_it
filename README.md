...
Offline-first MVP мобильного приложения для домашнего инвентаря: пользователь быстро создаёт иерархию мест хранения и находит, где именно лежит нужная вещь.
